...
>
	<g>
		<path
			style="fill:#1D1D1B;"
			d="M48.712,94.208c-2.929,2.929-2.929,7.678,0,10.606c2.93,2.929,7.678,2.929,10.607,0
		...
		<path
			style="fill:#1D1D1B;"
			d="M26.73,72.225c-2.929,2.929-2.929,7.678,0,10.606s7.677,2.93,10.607,0
		...
		<path
			style="fill:#1D1D1B;"
			d="M145.39,47.692c-39.479-39.479-103.715-39.479-143.193,0c-2.929,2.929-2.929,7.678,0,10.606
		...
		/>
		<circle style="fill:#1D1D1B;" cx="73.793" cy="121.272" r="8.231" />
	</g>
</svg>
